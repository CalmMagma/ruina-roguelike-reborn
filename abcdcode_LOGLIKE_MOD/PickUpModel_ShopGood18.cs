...
public class PickUpModel_ShopGood18 : ShopPickUpModel
{
  ...
  {
    Singleton<GlobalLogueEffectManager>.Instance.AddEffects((GlobalLogueEffectBase) new PickUpModel_ShopGood18.TongJang());
  }

  public string KeywordId => "GlobalEffect_RolandNft";
  ...
  public class TongJang : OnceEffect
  {
    ...
    public override Sprite GetSprite() => LogLikeMod.ArtWorks["ShopPassive18"];
    ...
    {
      return LogueEffectXmlList.AutoLocalizeVanillaDesc((GlobalLogueEffectBase) this, this.KeywordId, (object) (this.stack * 3));
    }
