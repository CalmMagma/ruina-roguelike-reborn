...
public class PassiveAbility_ShopPassive2_2 : PassiveAbilityBase
{
  ...
  public void Bufing()
  {
    List<BattleUnitModel> all = BattleObjectManager.instance.GetAliveList(this.owner.faction).FindAll((Predicate<BattleUnitModel>) (x => x != this.owner));
    if (all == null || all.Count == 0)
      return;
    all[UnityEngine.Random.Range(0, all.Count)].bufListDetail.AddBuf((BattleUnitBuf) new PassiveAbility_ShopPassive2_2.StreetLightBuf(this));
  }
  ...
  public class StreetLightBuf : BattleUnitBuf
  {
    ...
    {
      base.OnDie();
      this.parent.curbuf = (PassiveAbility_ShopPassive2_2.StreetLightBuf) null;
    }
