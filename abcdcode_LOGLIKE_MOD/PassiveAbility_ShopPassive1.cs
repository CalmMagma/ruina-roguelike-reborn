...
// Type: abcdcode_LOGLIKE_MOD.PassiveAbility_ShopPassive1
...
public class PassiveAbility_ShopPassive1 : PassiveAbilityBase
{
  public GameObject effect;

  public override string debugDesc => "1막에 위력 +1";
  ...
  public override void OnRoundStart()
  {
    ...
    {
      Sprite artWork = LogLikeMod.ArtWorks["ShopPassive1"];
