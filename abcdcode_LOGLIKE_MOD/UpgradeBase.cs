...
public class UpgradeBase
{
  ...
  public void EditUpInfo()
  {
    this.upxmlinfo.workshopID = LogCardUpgradeManager.UpgradeKeyword + this.baseinfo.workshopID;
    this.upxmlinfo.workshopName = this.baseinfo.workshopName + "+";
  }
