...
// Type: abcdcode_LOGLIKE_MOD.PickUpModel_ShopGood9
...
public class PickUpModel_ShopGood9 : ShopPickUpModel
{
  ...
  public string KeywordId => "GlobalEffect_StrStim";

  public class MegaPower : OnceEffect
  {
    public static Rarity ItemRarity = Rarity.Rare;

    public override Sprite GetSprite() => LogLikeMod.ArtWorks["ShopPassive9"];
