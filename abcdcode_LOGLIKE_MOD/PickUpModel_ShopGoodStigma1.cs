...
{
  public PickUpModel_ShopGoodStigma1()
  {
  ...
  {
    Singleton<GlobalLogueEffectManager>.Instance.AddEffects((GlobalLogueEffectBase) new PickUpModel_ShopGoodStigma1.Stigma1Effect());
  }

  public string KeywordId => "GlobalEffect_SlowBurn";
  ...
  public class Stigma1Effect : GlobalLogueEffectBase
  {
    ...
    public override Sprite GetSprite() => LogLikeMod.ArtWorks["ShopPassiveStigma1"];
