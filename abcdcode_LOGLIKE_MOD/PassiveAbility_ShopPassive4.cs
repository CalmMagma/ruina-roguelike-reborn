...
// Type: abcdcode_LOGLIKE_MOD.PassiveAbility_ShopPassive4
...
public class PassiveAbility_ShopPassive4 : PassiveAbilityBase
{
  public GameObject effect;

  public override string debugDesc => "4막에 위력 +4";
  ...
  public override void OnRoundStart()
  {
    ...
    {
      Sprite artWork = LogLikeMod.ArtWorks["ShopPassive4"];
