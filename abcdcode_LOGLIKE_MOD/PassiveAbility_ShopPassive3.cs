...
// Type: abcdcode_LOGLIKE_MOD.PassiveAbility_ShopPassive3
...
public class PassiveAbility_ShopPassive3 : PassiveAbilityBase
{
  public GameObject effect;

  public override string debugDesc => "3막에 위력 +3";
  ...
  public override void OnRoundStart()
  {
    ...
    {
      Sprite artWork = LogLikeMod.ArtWorks["ShopPassive3"];
